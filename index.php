...
<head>
    ...
    <script type="module" src="JsScripts/main.js" async></script>
</head>
<body>

    <div class="register-popup <?php
        if(isset($_GET["errorRegister"])){
            echo 'active';
        }
    ?>">
        <div class="close-btn register-close">&times;</div>
        <div class="swap-log-in"><span>Are u a member? <strong><span class="logIn text-black">Log In</span></strong></span></div>
        <form action="Script/signup.inc.php" method="post">
        <div class="form">
            <h2>Register</h2>
            <div class="form-elem">
                <input type="text" id="register-username" name="name" placeholder="Name" autocomplete="off"
                <?php if(isset($_GET["1"])){echo 'value="'.$_GET["1"].'"';}?> required
                >
            </div>
            <div class="form-elem">
                <input type="text" id="register-useruid" name="uid" placeholder="Login" autocomplete="off"
                <?php if(isset($_GET["2"])){echo 'value="'.$_GET["2"].'"';}?> required>
            </div>
            <div class="form-elem">
                <input type="text" id="register-email" name="email" placeholder="Email" autocomplete="off"
                <?php if(isset($_GET["3"])){echo 'value="'.$_GET["3"].'"';}?> required> 
            </div>
            <div class="form-elem">
                <input type="password" id="register-password" name="password" placeholder="Password" autocomplete="off" required> 
                <label>Password must be at least 8 characters and contain at least one number, one UPPERCASE and one lowercase letter</label>
            </div>
            <div class="form-elem">
                <input type="password" id="password-repeat" name="passwordRepeat" placeholder="Repeat Password" autocomplete="off" required> 
            </div>
            <!-- <div class="form-elem">
                <label for="date">Date of Birth: &nbsp&nbsp&nbsp</label> 
                <input type="date" id="date" name="date" placeholder="EnterDate" autocomplete="off"> 
            </div> -->
            <div class="form-elem">
                <input type="checkbox" id="checkbox2" name="checkbox2">
                <label for="checkbox2">I read and accept privacy policy</label> 
            </div>
            <div class="form-elem">
        ...
        <?php
            if(isset($_GET["errorRegister"])){
                if($_GET["errorRegister"] == "emptyInput"){
                    echo "<span class='errorMsg'>Fill in all fields!</span>";
                }else if($_GET["errorRegister"] == "passwordNotStrong"){
                    echo "<span class='errorMsg'>Password must be at least 8 characters and contain at least one number</span>";
                }else if($_GET["errorRegister"] == "invalidName"){
                    echo "<span class='errorMsg'>The name must contain only letters and numbers</span>";
                }else if($_GET["errorRegister"] == "invalidUid"){
                    echo "<span class='errorMsg'>The Username must contain only the letters of the number and be at least 5 characters long</span>";
                }else if($_GET["errorRegister"] == "invalidEmail"){
                    echo "<span class='errorMsg'>Choose a proper email!</span>";
                }else if($_GET["errorRegister"] == "passwordNotEqual"){
                    echo "<span class='errorMsg'>Password doesn't match!</span>";
                }else if($_GET["errorRegister"] == "usernameTaken"){
                    echo "<span class='errorMsg'>Username or Email already taken!</span>";
                }else if($_GET["errorRegister"] == "stmtFailed"){
                    echo "<span class='errorMsg'>Something went wrong, try again!</span>";
                }else if($_GET["errorRegister"] == "none"){
                    echo "<span class='errorMsg2'>Sign up successfully, check Your email to active account!</span>";
                }
    ...
    <div class="login-popup <?php
        if(isset($_GET["errorLogin"])){
            echo 'active';
        }
    ?>">
        <div class="close-btn login-close">&times;</div>
        <div class="swap-log-in"><span>Not a member? <strong><span class="Register text-black">Register</span></strong></span></div>
        ...
        <div class="form">
            ...
            <div class="form-elem">
                ...
                <button type="submit" name="resend" style="width: 50%;
    font-size: 1em;
    margin-left: 50%;
    color: black;
    background-color: #F2F2F2;"> Re send activation link</button>
            </div>
        </div>
        </form>
        ...
        <?php
            if(isset($_GET["errorLogin"])){
                if($_GET["errorLogin"] == "emptyInput"){
                    ...
                    echo "<span class='errorMsg'>Incorrect Username or Password</span>";
                }else if($_GET["errorLogin"] == "noActive"){
                    echo "<span class='errorMsg'>You need to activate your account, check your email.</span>";
                }else if($_GET["errorLogin"] == "emptyResend"){
                    echo "<span class='errorMsg'>Fill username to resend activation link.</span>";
                }else if($_GET["errorLogin"] == "Resended"){
                    echo "<span class='errorMsg2'>Activation link resendend.</span>";
                }
            }
        ?>
    ...
    <div id="Head">
                ...
                <div class="item login">
                    <?php
                        if (isset($_SESSION["useruid"])){
                            echo '<span>Everything for now?</span>
                            <strong>
                                <a href="Script/logout.inc.php"><span class="open-logout text-logout"> Logout</span></a>
                            </strong>';
                        }else{
                            echo '<span>Are you a member?</span>
                            <strong>
                                <span class="open-register text-black"> Register</span> / <span class="open-login text-black">Log In</span>
                            </strong>';
                        }
                    ?>
        ...
        <div class="logo-header">
            <svg width="141" height="75" viewBox="0 0 280 44.3">
    ...
    <div id="Content">
        ...
        <section class="main-paralax">
            <img src="Img/Paralax/circle.png" data-speed="-3" class="paralax">
            <img src="Img/Paralax/divide.png" data-speed="1" class="paralax">  
            <img src="Img/Paralax/minus.png" data-speed="2" class="paralax">  
            <img src="Img/Paralax/plus.png" data-speed="2" class="paralax">  
            <img src="Img/Paralax/squere.png" data-speed="-3" class="paralax">  
            <img src="Img/Paralax/triangle.png" data-speed="4" class="paralax">  
            <img src="Img/Paralax/x.png" data-speed="-4" class="paralax">    
            <img src="Img/Paralax/minus.png" data-speed="1" class="paralax">    
            <img src="Img/Paralax/squere.png" data-speed="2" class="paralax">    
        </section>

        
    
        <div class="box-left">
            <img src="Img/bcg.png" alt="bcg" class='main-img'>
        </div>
        
        <div class="box-right">
                <img src="Img/bcg.png" alt="bcg" class='right-img'>
            <div class="center-text">
                <span class="main-txt"><p>Short-term Memory is very important <br>in our daily life,<br>
                it is necessary for proper functioning <br>in every sphere of it. <br>
                Thanks to her, we can easily</p></span>
            </div>
            ...
            <div class="txts">
                <div class="txt">Performing simple math <br> calculations in your head.</div>
                <div class="txt">Saving e.g. a telephone <br> number until it is saved.</div>
                <div class="txt">Remembering the threads raised by the <br>interlocutors and building statements<br> adequate to the conversation.</div>
            </div>
        ...
        <div class="sticky-menu">
            <?php
            if (isset($_SESSION["useruid"])){
                echo '<a href="Script/logout.inc.php"><div class="side-menu-item menu-logout" >LogOut</div></a>';
                echo '<a href="Sites/User.php?game=FlipACard"><div class="side-menu-item menu-profile" >Profile</div></a>';
                echo '<a href="Sites/games.php"><div class="side-menu-item menu-memory-games">Games</div></a>';
            }else {
            ...
            ?>
            <a href="Sites/AboutSite.php"><div class="side-menu-item menu-about">About Site</div></a>    
        </div>
    </div>
            ...
            <div class="inner">
                <div class="box-left">
                    <ul class="menu-footer">
                        <li>
                            <a class="text-black" rel="nofollow" href="/Sites/AboutSite.php">About Site</a>
                        </li>
                        <li>

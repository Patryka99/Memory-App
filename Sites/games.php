...
<body>
    ...
    <div id="Content">
        <div id="cover">
            <div id="games">
                <a href="FlipACard.php"><div id="game">
                    <div class="gameIcon icon1" >
                        
                    </div>
                    <div class="gameName">
                        <span class="nameHeader"> Flip a Card </span><br> <span class="nameLower"> In this game u need to match all cards just by clicking them.</span>
                    </div>
                </div></a>
                <a href="GameStart.php?game=Crossword"><div id="game">
                    <div class="gameIcon icon2">
                        
                    </div>
                    <div class="gameName">
                    <span class="nameHeader"> Word Crossword </span><br> <span class="nameLower"> In this game u need to arrange words from letters</span>
                    </div>
                </div></a>
                <a href="GameStart.php?game=Simon"><div id="game">
                    <div class="gameIcon icon3">
                        
                    </div>
                    <div class="gameName">
                    <span class="nameHeader"> Simon says </span><br> <span class="nameLower"> In this game u need to follow the simon.</span>
                    </div>
                </div></a>
                <a href="Sudoku.php"><div id="game">
                    <div class="gameIcon icon4">
                        
                    </div>
                    <div class="gameName">
                    <span class="nameHeader"> Sudoku </span><br> <span class="nameLower"> Just classic sudoku.</span>
                    </div>
                </div></a>
                <a href="GameStart.php?game=SlidePuzzle"><div id="game">
                    <div class="gameIcon icon5">
                        
                    </div>
                    <div class="gameName">
                    <span class="nameHeader"> SlidePuzzle </span><br> <span class="nameLower"> U need to solve a puzzle by sliding them using arrows.</span>
                    </div>
                </div></a>
                <a href="MathGame.php"><div id="game">
                    <div class="gameIcon icon6">
                        
                    </div>
                    <div class="gameName">
                    <span class="nameHeader"> MathGame </span><br> <span class="nameLower"> Some math.</span>
                    </div>
                </div></a>
            </div>
        </div>
    ...
    <div class="side-menu">
        <div class="sticky-menu">
            ...
            <a href="../"><div class="side-menu-item menu-about">Home</div></a>  
        </div>
    </div>

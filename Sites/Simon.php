...
<!-- <div class="register-popup">
    ...
    <h1 class="page-title">Saymon Says</h1>
    <div id="main_overlay" class="overlay-text">
        Click to Start
    </div>
    ...
    <div id="over-txt" class="overlay-text">
        ...
        <input type="text" id="gameDif" name="gameTime" value="0" style="visible:none;" />
        <input type="text" id="gameDif" name="gameDif" value="NONE" style="visible:none;" />
        <input type="text" id="gameInput" name="gameInput" value="SimonSays" style="visible:none;" />
        <input type="number" id="scoreInput" name="scoreInput" style="visible:none;" />
    ...
    <div id="victory-txt" class="overlay-text">
        ...
        <input type="text" id="gameInput" name="gameInput" value="SimonSays" style="visible:none;" />
        <input type="number" id="scoreInput" name="scoreInput" style="visible:none;" />
        <span class="overlay-text-small">Your score: </span><span id="endScoreV">0</span>
        <div id="gridBtn">
            <button class="newGame" type="submit" name="submit">New Game</button>
            <button id="lb" class="newGame" type="submit" name="leaderBoard">View LeaderBoard</button>
        </div>
    ...
    <div class="game-container">
        <div class="game-info-container">
            <div class="game-info">
                Stage: <span id="counter">1</span></br>
                Score: <span id="score">0</span>
            </div>
        </div>
        <div class="plate one"><div data-value="1" class="lighter"></div></div>
        <div class="plate two"><div data-value="2" class="lighter"></div></div>
        <div class="plate three"><div data-value="3" class="lighter"></div></div>
        <div class="plate four"><div data-value="4" class="lighter"></div></div>
        <div class="plate five"><div data-value="5" class="lighter"></div></div>
        <div class="plate six"><div data-value="6" class="lighter"></div></div>
        <div class="plate seven"><div data-value="7" class="lighter"></div></div>
        <div class="plate eight"><div data-value="8" class="lighter"></div></div>
        <div class="plate nine"><div data-value="9" class="lighter"></div></div>
    </div>

...
<head>
    ...
    <script src="../JsScripts/aboutSite.js" async></script>
</head>
<body>
    <div id="Head">
    ...
    <div id="Content">
        ...
        <div id="gridWrap">
            <div class="test" id="aSite">
                <span class="headerText">&nbsp About Site &nbsp</span><br>
                <span class="descText">The website was created as part of an engineering thesis</span><br><br>
                <span class="titleText">'The web application to train short-term memory'</span><br><br>
                <span class="descText">You will find here several games that will help you train your short-term memory in an easy and fun way</span>
            </div>
            <div class="test" id="aMe">
                <div class="headGrid"><span class="headerText">&nbsp About Me &nbsp</span></div>
                <!-- <div class="leftGrid"><img src="../Img/jjj.jpg" alt="Me" class="square"></div> -->
                <div class="leftGrid"><div class="gallery">
                    <img src="../Img/Me/6.jpg" alt="Me">
                    <img src="../Img/Me/5.jpg" alt="Me">
                    <img src="../Img/Me/7.jpg" alt="Me">
                    <img src="../Img/Me/8.jpg" alt="Me">
                </div></div>
                <div class="rightGrid"><span class="descText typeWord"></span></div>
            </div>
            <div class="test" id="cMe">
                <div class="headGrid"><span class="headerText">&nbsp Contact Me &nbsp</span></div>
                <div class="middleGrid"></br></br> <span class="descText">Contact me via E-mail:</span><br><br> <span class="titleText">Patryk.arendt99@gmail.com</span></div>
                <div class="rightGrid">
                </div>
            ...
            <div class="inner">
                <div class="box-left">
                    <ul class="menu-footer">
                        <li>
                            <a class="text-black" rel="nofollow" href="">About Site</a>
                        </li>
                        <li>

...
<body>
    ...
    <div id="Content">
        <div id="container">
            <div id="usermenu">
            <a href="User.php?game=FlipACard"><div class="side-menu-item2"><img src="../Img/User/card.png" alt=""> FLIP A CARD <img src="../Img/User/card2.png" alt=""></div></a>
            <a href="User.php?game=Crossword"><div class="side-menu-item2"><img src="../Img/User/crossword2.png" alt=""> CROSSWORD <img src="../Img/User/crossword.png" alt=""></div></a>
            <a href="User.php?game=Simon"><div class="side-menu-item2"><img src="../Img/User/simon.png" alt=""> SIMON SAYS <img src="../Img/User/simon.png" alt=""></div></a>
            <a href="User.php?game=Sudoku"><div class="side-menu-item2"><img src="../Img/User/sudoku.png" alt=""> SUDOKU <img src="../Img/User/sudoku.png" alt=""></div></a>
            <a href="User.php?game=SlidePuzzle"><div class="side-menu-item2"><img src="../Img/User/slide.png" alt=""> SLIDE PUZZLE <img src="../Img/User/slide2.png" alt=""></div></a>
            <a href="User.php?game=MathGame"><div class="side-menu-item2"><img src="../Img/User/math.png" alt=""> MATH GAME <img src="../Img/User/math.png" alt=""></div></a> 
            </div>
            <div id="gamesinfo">
                <div>
                    <?php
                    if(!isset($_GET['diff']) && !isset($_GET['game'])){
                        echo "<span style='font-size: 5em;'>No active GAME, Chose game in right Menu</span>";
                    }
                        if(isset($_GET['game']))
                        {
                            if(isset($_GET['diff']))
                            {
                                $chartInfo = getChartInfo2($conn, $_GET['game'], $_SESSION['useruid'], $_GET['diff']);
                            }else{
                                $chartInfo = getChartInfo($conn, $_GET['game'], $_SESSION['useruid']);
                            }
                            if($chartInfo == false){
                                $score[] = 0;
                                $date[] = 0;
                                ...
                                foreach ($chartInfo as $row) {
                                    $score[] = $row['gamesScore'];
                                    $date[] = $row['gamesDate'];
                                }
                            }
                            if($chartInfo == false && !isset($_GET['diff'])){
                                echo "<br><span style='font-size: 2em;'></span>";
                            }
                            
                            if($_GET['game'] == 'FlipACard' || $_GET['game'] == 'Sudoku' || $_GET['game'] == 'MathGame')
                            {
                                $output = '<a class="btnOut" href="User.php?game=';
                                $output .= $_GET['game'];
                                $output .= '"><div class="btnDif">ALL</div><a/>';
                                $output .= '<a class="btnOut" href="User.php?game=';
                                $output .= $_GET['game'];
                                $output .= '&diff=EASY"><div class="btnDif">EASY</div><a/>';
                                $output .= '<a class="btnOut" href="User.php?game=';
                                $output .= $_GET['game'];
                                $output .= '&diff=MEDIUM"><div class="btnDif">MEDIUM</div><a/>';
                                $output .= '<a class="btnOut" href="User.php?game=';
                                $output .= $_GET['game'];
                                $output .= '&diff=HARD"><div class="btnDif">HARD</div><a/>';
                                echo $output;
                                if($chartInfo == false){
                                    echo "<br><span style='font-size: 2em;'>No Data For this game</span>";
                                }
                            }
                        }
                        else{
                    ...
                    ?>
                    <div id="chart" <?php if(!isset($_GET['diff']) && isset($_GET['game'])){ if($_GET['game'] == 'FlipACard' || $_GET['game'] == 'Sudoku'){}else echo 'style="margin-top: 3%;"';} ?>>
                    ...
                    <script>
                        const labels = <?php echo json_encode($date) ?>;
                            ...
                            labels: labels,
                            datasets: [{
                                label: '<?php echo $_GET["game"]. " Score" ?>',
                                backgroundColor: 'rgb(217, 69, 143)',
                                borderColor: 'rgb(217, 69, 143)',
                                borderWidth: 1,
                                hoverBorderWidth: 3,
                                hoverRadius: 5,
            ...
            if(isset($_GET["game"])){
                if(isset($_GET['diff']))
                {
                    $scoreTable = getBestScore2($conn, $_GET["game"], $_SESSION["useruid"], $_GET["diff"]);
                }else{
                    $scoreTable = getBestScore($conn, $_GET["game"], $_SESSION["useruid"]);
                }
    ...
    <div class="side-menu">
        <div class="sticky-menu">
            ...
            if (isset($_SESSION["useruid"])){
                ...
                echo '<div class="side-menu-item menu-profile" >Profile</div>';

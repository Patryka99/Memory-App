...
<html lang="en">
    <head>
        ...
        <script type="module" src="../JsScripts/SlidePuzzle/slidePuzzle.js"></script>
    ...
    <h1 class="page-title">Slide Puzzle</h1>
    <h2 id="info">Moves: <span id="moves">0</span></h2>
    ...
    WINNER
        ...
        <input type="text" id="gameInput" name="gameInput" value="SlidePuzzle" style="display:none;" />

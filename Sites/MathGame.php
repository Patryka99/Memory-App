...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../Style/mathGame.css">
        <link rel="stylesheet" href="../Style/Style.css">
        <script src="../JsScripts/MathGame/mathGame.js"></script>
...
<div id="victory-txt" class="overlay-text">
        GAME OVER
        <form action="../Script/games.inc.php" method="post" style="width: 100%; text-align: center;">
        <input type="text" id="gameTime" name="gameTime" value="0" style="visible:none;" />
        <input type="text" id="gameDif" name="gameDif" value="NONE" style="visible:none;" />
        <input type="text" id="gameInput" name="gameInput" value="MathGame" style="visible:none;" />
...
<div id="container">
    ...
    <div id="timeDiv">Time left: <span id="time">10</span></div>
    <div id="operation">0 * 0</div>
    <span id="question-text">What is the answer?</span><br>
    <div id="btngames">
        <button class="gamebtn" id="btn1" onclick="checkAnswer(1)">0</button>
        <button class="gamebtn" id="btn2" onclick="checkAnswer(2)">0</button>
        <button class="gamebtn" id="btn3" onclick="checkAnswer(3)">0</button>
        <button class="gamebtn" id="btn4" onclick="checkAnswer(4)">0</button>
        <button class="gamebtn btnHard" id="btn5" onclick="checkAnswer(5)">0</button>
        <button class="gamebtn btnHard" id="btn6" onclick="checkAnswer(6)">0</button>
    </div>

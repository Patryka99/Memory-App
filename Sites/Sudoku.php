...
<html lang="en">
    <head>
        ...
        <script src="../JsScripts/sudokuScript.js"></script>
...
<div id="Head">
    ...
    <h2 id="info">Wrong: <span id="errors">0</span></h2>
    <h2 id="info">Time: <span id="time">0</span></h2>
    <div id="main_overlay" class="overlay-text visible">
    <div id="startGameInfo">
            <div id="howToPlay">
                <h2>How to play</h2>
                <span class="playInfo">Sudoku is played on a grid of 9 x 9 spaces.Each row, 
                    column and square (9 spaces each) needs to be filled out with the numbers 1-9, 
                    without repeating any numbers within the row, column or square.Does it sound complicated? </span>
                <h2>Control</h2>
                <span class='playInfo'>Control is very Simply first u need to click at number at bottom on the screen.Then you can place this number by clicking on board.</span>
            </div>
            <div id="choseDif">
    ...
    WINNER
        ...
        <input type="text" id="gameInput" name="gameInput" value="Sudoku" style="display:none;" />

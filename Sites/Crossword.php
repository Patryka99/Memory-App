...
<head>
    <meta charset="UTF-8">
    <title>Memory - Crossword</title>
    <link rel="stylesheet" href="../Style/crossword.css">
    <link rel="stylesheet" href="../Style/Style.css">
    <script src="../JsScripts/CrossWord/Crossword.js" async></script>
    <script src="../JsScripts/CrossWord/functions.js" async></script>
    <script src="../JsScripts/CrossWord/eventListeners.js" async></script>
...
<body>
    ...
    <div id="victory-txt" class="overlay-text">
        ...
        <input type="text" id="gameInput" name="gameInput" value="Crossword" style="visible:none;" />
    ...
    <div id="info">
        <div id="input-info">
            <div id="input-string">Click to start</div>
            <div id="alphabetic-keys">
                <div class="alphabetic-key">
                    <img src="../Img/Crossword/alphabet key.jpg" alt="">
                    <span><b>A</b></span>
                </div>
                <div class="alphabetic-key">
                    <img src="../Img/Crossword/alphabet key.jpg" alt="">
            ...
            <div id="other-keys">
                <div id="space-key">
                    <img src="../Img/Crossword/space key.jpg" alt="">
                    <span><b>Space bar</b></span>
                </div>
                <div id="backspace-key">
                    <img src="../Img/Crossword/backspace key.jpg" alt="">
        ...
        <div id="timer">
            <div id="clock">
                <span id="countdown">200</span>
            </div>
        </div>
        <div id="score">
            <div id="scoreText">Score: <span id="scoreValue">0</span> </div>
        </div>
        <div id="skip">
            Enter - skip lvl
            Available: <span id="skipLeft">3</span>
        </div>
    </div>
